...
ICONNAME=icons/nanos_app_angle.gif
else ifeq ($(TARGET_NAME), TARGET_STAX)
ICONNAME=icons/stax_app_angle.gif
DEFINES += ICONGLYPH=C_stax_angle_64px
DEFINES += ICONBITMAP=C_stax_angle_64px_bitmap
GLYPH_FILES += $(ICONNAME)
else
ICONNAME=icons/nanox_app_angle.gif
endif
